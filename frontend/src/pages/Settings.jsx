...
const Settings = () => {
    ...
    return (
        ...
        <div>
        {toggleEditImg === true ? <>
                    <input onChange={(event) => setEditImg(event.target.value)} value={editImg} />
                    <button onClick={() => handleEdit(editImg, "display_pic_url")}>Change</button>
                    <br/>
                  </> : 
                  <img className="profilepic" src={user.display_pic_url} />
                  }
        <br />
        <button onClick={() => setToggleEditImg(true)}>Change display image</button>
        </div>
        ...
        <br />
        <button onClick={() => setToggleEditDesc(true)}>edit description</button>
        </div>
        ...
        {toggleDelete === true ? 
            ...
            <button onClick={()=> setToggleDelete(true)}>Delete your account</button>
    }
